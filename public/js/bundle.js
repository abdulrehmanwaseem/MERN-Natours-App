...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var bounds = new mapboxgl.LntLatBounds();
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.desciption, "</p>")).addTo(map);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          (0, _alerts.showAlert)('error', _context.t0.message || 'An error occurred');
        case 14:
        case "end":
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'passowrd' ? 'http://127.0.0.1:8000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:8000/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: url,
        ...
        case 8:
          ...
          (0, _alerts.showAlert)(_context.t0, 'Something went wrong');
        case 11:
        case "end":
          return _context.stop();
      }
...
var loginOutBtn = document.querySelector('.nav__el--logout');
...
if (loginOutBtn) loginOutBtn.addEventListener('click', _login.logout);
if (userDataForm) {
